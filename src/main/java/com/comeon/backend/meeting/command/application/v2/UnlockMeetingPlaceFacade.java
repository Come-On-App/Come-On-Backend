...
public class UnlockMeetingPlaceFacade {

    private final MeetingRepository meetingRepository;

    public void unlockMeetingPlace(Long userId, Long meetingId, Long meetingPlaceId) {
        Meeting meeting = meetingRepository.findMeetingBy(meetingId)
                .orElseThrow(() -> new MeetingNotExistException(meetingId));
        meeting.unlockPlace(userId, meetingPlaceId);
    }
}
