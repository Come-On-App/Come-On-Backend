...
import com.comeon.backend.meetingmember.api.MeetingJoinApiController;
...
@WebMvcTest({MeetingJoinApiController.class})
class MeetingJoinApiControllerTest extends RestDocsTestSupport {
    ...
    class meetingJoin {
        ...
        void join() throws Exception {
            ...
            BDDMockito.given(meetingMemberFacade.joinMeeting(BDDMockito.anyLong(), BDDMockito.any()))
