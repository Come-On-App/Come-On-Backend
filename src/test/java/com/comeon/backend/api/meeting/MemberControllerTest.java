...
import com.comeon.backend.meeting.presentation.api.member.MemberController;
import com.comeon.backend.meeting.presentation.api.member.HostRoleDelegateRequest;
import com.comeon.backend.meeting.presentation.api.member.MemberDropRequest;
import com.comeon.backend.meeting.command.application.DelegateHostRoleFacade;
import com.comeon.backend.meeting.command.application.DropMemberFacade;
import com.comeon.backend.meeting.command.application.LeaveMeetingFacade;
...
class MemberControllerTest extends RestDocsTestSupport {
    ...
    @MockBean
    LeaveMeetingFacade leaveMeetingFacade;

    @MockBean
    DelegateHostRoleFacade delegateHostRoleFacade;

    @MockBean
    DropMemberFacade dropMemberFacade;
    ...
    class meetingLeave {
        ...
        void success() throws Exception {
            //given
            Long meetingIdMock = 55L;
            BDDMockito.willDoNothing().given(leaveMeetingFacade)
                    .leaveMeeting(BDDMockito.anyLong(), BDDMockito.anyLong());
    ...
    class memberDrop {
        ...
        void success() throws Exception {
            ...
            BDDMockito.willDoNothing().given(dropMemberFacade)
                    .dropMember(BDDMockito.anyLong(), BDDMockito.anyLong());
    ...
    class hostAuthDelegate {
        ...
        void success() throws Exception {
            //given
            Long meetingIdMock = 55L;
            HostRoleDelegateRequest request = new HostRoleDelegateRequest(423L);

            BDDMockito.willDoNothing().given(delegateHostRoleFacade)
                    .delegateHostRole(BDDMockito.anyLong(), BDDMockito.anyLong());
