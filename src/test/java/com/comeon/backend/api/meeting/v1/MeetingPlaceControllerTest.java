            ...
            perform.andDo(
                    restDocs.document(
                            ...
                            PayloadDocumentation.responseFields(
                                    ...
                                    PayloadDocumentation.fieldWithPath("lng").type(JsonFieldType.NUMBER).description("장소의 경도값"),
                                    ...
                                    PayloadDocumentation.fieldWithPath("googlePlaceId").type(JsonFieldType.STRING).description("Google Place API에서 장소의 식별값")
                            )
                    )
            );
        }
