...
import com.comeon.backend.user.api.UserLogoutController;
...
public class UserLogoutControllerTest extends RestDocsTestSupport {

    String baseEndpoint = "/api/v1/users/logout";
    ...
    class logout {
        ...
        @Test
        @DisplayName("given: 인증 필수 -> then: Http 200")
        void success() throws Exception {
            //given
            BDDMockito.willDoNothing().given(jwtManager)
                    .logout(BDDMockito.anyLong());
