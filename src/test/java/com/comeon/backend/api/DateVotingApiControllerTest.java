...
@WebMvcTest(DateVotingApiController.class)
public class DateVotingApiControllerTest extends RestDocsTestSupport {

    @MockBean
    VotingFacade votingFacade;
    ...
    class votingAdd {
        ...
        void success() throws Exception {
            //given
            AddVotingRequest request = new AddVotingRequest("2023-03-13");
            BDDMockito.willDoNothing().given(votingFacade)
    ...
    class votingRemove {
        ...
        void success() throws Exception {
            //given
            RemoveVotingRequest request = new RemoveVotingRequest("2023-03-13");
            BDDMockito.willDoNothing().given(votingFacade)
    ...
    class votingSimpleList {
        ...
        void success() throws Exception {
            ...
            BDDMockito.given(dateVotingDao.findVotingSimpleListByMeetingIdWhetherMyVoting(BDDMockito.anyLong(), BDDMockito.anyLong()))
                    .willReturn(
                            List.of(
                                    new VotingSimpleResponse(LocalDate.of(2023, 3,1), 1, true),
                                    new VotingSimpleResponse(LocalDate.of(2023, 3,2), 1, false),
                                    new VotingSimpleResponse(LocalDate.of(2023, 3,8), 5, true),
                                    new VotingSimpleResponse(LocalDate.of(2023, 3,9), 1, false),
                                    new VotingSimpleResponse(LocalDate.of(2023, 3,10), 2, false),
                                    new VotingSimpleResponse(LocalDate.of(2023, 3,13), 4, true)
                            )
                    );
